...
!function (a, b) {
  ...
  var t = function (a) {
    ...
    function gb(a, b, d, e) {
      ...
      ], k = b.nodeType, 'string' != typeof a || !a || 1 !== k && 9 !== k && 11 !== k) return d;
      if (!e && p) {
    ...
    i = gb.select = function (a, b, e, f) {
      ...
      if (e = e || [
        ...
        if (j = o[0] = o[0].slice(0), j.length > 2 && 'ID' === (k = j[0]).type && c.getById && 9 === b.nodeType && p && d.relative[j[1].type]) {
          if (b = (d.find.ID(k.matches[0].replace(cb, db), b) || [
          ]) [0], !b) return e;
          n && (b = b.parentNode),
  ...
  n.fn.extend({
    ...
    filter: function (a) {
      return this.pushStack(x(this, a || [
      ], !1))
    },
    not: function (a) {
      return this.pushStack(x(this, a || [
    ...
    is: function (a) {
      return !!x(this, 'string' == typeof a && u.test(a) ? n(a) : a || [
      ], !1).length
    }
  });
  var y,
  ...
  n.fn.extend({
    ...
    closest: function (a, b) {
      ...
      ], g = u.test(a) || 'string' != typeof a ? n(a, b || this.context) : 0; e > d; d++) for (c = this[d]; c && c !== b; c = c.parentNode) if (c.nodeType < 11 && (g ? g.index(c) > - 1 : 1 === c.nodeType && n.find.matchesSelector(c, a))) {
        f.push(c);
        break
      }
          ...
          return n.Deferred(function (c) {
            n.each(b, function (b, f) {
              ...
              e[f[1]](function () {
                ...
                a && n.isFunction(a.promise) ? a.promise().done(c.resolve).fail(c.reject).progress(c.notify) : c[f[0] + 'With'](this === d ? c.promise() : this, g ? [
                  a
                ] : arguments)
              })
            }),
  ...
  n.extend({
    ...
    ready: function (a) {
      (a === !0 ? --n.readyWait : n.isReady) || (n.isReady = !0, a !== !0 && --n.readyWait > 0 || (H.resolveWith(l, [
        n
  ...
  n.extend({
    queue: function (a, b, c) {
      var d;
      return a ? (b = (b || 'fx') + 'queue', d = L.get(a, b), c && (!d || n.isArray(c) ? d = L.access(a, b, n.makeArray(c)) : d.push(c)), d || [
      ]) : void 0
    },
  ...
  n.event = {
    ...
    add: function (a, b, c, d, e) {
      ...
      if (r) {
        ...
        ], m.delegateCount = 0, l.setup && l.setup.call(a, d, p, g) !== !1 || a.addEventListener && a.addEventListener(o, g, !1)), l.add && (l.add.call(a, k), k.handler.guid || (k.handler.guid = c.guid)), e ? m.splice(m.delegateCount++, 0, k) : m.push(k), n.event.global[o] = !0)
      }
    },
    ...
    trigger: function (b, c, d, e) {
      ...
      if (g = h = d = d || l, 3 !== d.nodeType && 8 !== d.nodeType && !X.test(q + n.event.triggered) && (q.indexOf('.') >= 0 && (r = q.split('.'), q = r.shift(), r.sort()), k = q.indexOf(':') < 0 && 'on' + q, b = b[n.expando] ? b : new n.Event(q, 'object' == typeof b && b), b.isTrigger = e ? 2 : 3, b.namespace = r.join('.'), b.namespace_re = b.namespace ? new RegExp('(^|\\.)' + r.join('\\.(?:.*\\.|)') + '(\\.|$)') : null, b.result = void 0, b.target || (b.target = d), c = null == c ? [
        b
      ] : n.makeArray(c, [
        b
      ]), o = n.event.special[q] || {
    ...
    dispatch: function (a) {
      ...
      if (i[0] = a, a.delegateTarget = this, !k.preDispatch || k.preDispatch.call(this, a) !== !1) {
        ...
        while ((f = h[b++]) && !a.isPropagationStopped()) {
          ...
          c = 0;
          while ((g = f.handlers[c++]) && !a.isImmediatePropagationStopped()) (!a.namespace_re || a.namespace_re.test(g.namespace)) && (a.handleObj = g, a.data = g.data, e = ((n.event.special[g.origType] || {
          }).handle || g.handler).apply(f.elem, i), void 0 !== e && (a.result = e) === !1 && (a.preventDefault(), a.stopPropagation()))
        }
    ...
    handlers: function (a, b) {
      ...
      if (h && i.nodeType && (!a.button || 'click' !== a.type)) for (; i !== this; i = i.parentNode || this) if (i.disabled !== !0 || 'click' !== a.type) {
        ...
        e = f.selector + ' ',
        void 0 === d[e] && (d[e] = f.needsContext ? n(e, this).index(i) >= 0 : n.find(e, this, null, [
          i
        ]).length),
        d[e] && d.push(f);
        d.length && g.push({
  ...
  n.extend({
    ...
    buildFragment: function (a, b, c, d) {
      ...
      ], m = 0, o = a.length; o > m; m++) if (e = a[m], e || 0 === e) if ('object' === n.type(e)) n.merge(l, e.nodeType ? [
        e
      ] : e);
       else if (cb.test(e)) {
  ...
  n.each({
    ...
    n.fn[a] = function (a) {
      for (var c, d = [
      ], e = n(a), g = e.length - 1, h = 0; g >= h; h++) c = h === g ? this : this.clone(!0),
      n(e[h]) [b](c),
      f.apply(d, c.get());
  ...
  function Ub(a, b, c) {
    for (var d, e = (Rb[b] || [
    ]).concat(Rb['*']), f = 0, g = e.length; g > f; f++) if (d = e[f].call(c, b, a)) return d
  }
  function Vb(a, b, c) {
    var d,
    e,
    ...
    1 === a.nodeType && ('height' in b || 'width' in b) && (c.overflow = [
      ...
      o.overflowX,
      o.overflowY
    ], j = n.css(a, 'display'), k = 'none' === j ? L.get(a, 'olddisplay') || tb(a.nodeName) : j, 'inline' === k && 'none' === n.css(a, 'float') && (o.display = 'inline-block')),
  ...
  n.fn.extend({
    addClass: function (a) {
      ...
      ]; j > i; i++) if (c = this[i], d = 1 === c.nodeType && (c.className ? (' ' + c.className + ' ').replace(ac, ' ') : ' ')) {
        f = 0;
    ...
    valHooks: {
      ...
      select: {
        get: function (a) {
          ...
          ], h = f ? e + 1 : d.length, i = 0 > e ? h : f ? e : 0; h > i; i++) if (c = d[i], !(!c.selected && i !== e || (k.optDisabled ? c.disabled : null !== c.getAttribute('disabled')) || c.parentNode.disabled && n.nodeName(c.parentNode, 'optgroup'))) {
  ...
  n.extend({
    ...
    ajax: function (a, b) {
      ...
      if (o.promise(v).complete = p.add, v.success = v.done, v.error = v.fail, k.url = ((a || k.url || oc) + '').replace(ec, '').replace(jc, pc[1] + '//'), k.type = b.method || b.type || k.method || k.type, k.dataTypes = n.trim(k.dataType || '*').toLowerCase().match(E) || [
        ''
      ], null == k.crossDomain && (h = kc.exec(k.url.toLowerCase()), k.crossDomain = !(!h || h[1] === pc[1] && h[2] === pc[2] && (h[3] || ('http:' === h[1] ? '80' : '443')) === (pc[3] || ('http:' === pc[1] ? '80' : '443')))), k.data && k.processData && 'string' != typeof k.data && (k.data = n.param(k.data, k.traditional)), rc(lc, k, b, v), 2 === t) return v;
      i = n.event && k.global,
  ...
  n.fn.extend({
    offset: function (a) {
      ...
      n.contains(b, d) ? (typeof d.getBoundingClientRect !== U && (e = d.getBoundingClientRect()), c = Jc(f), {
...
/*! lazysizes - v1.1.0-rc3 - Licensed MIT */
!function (a, b) {
  var c = b(a, a.document);
  a.lazySizes = c,
  'object' == typeof module && module.exports ? module.exports = c : 'function' == typeof define && define.amd && define(c)
}(window, function (a, b) {
  'use strict';
  if (b.getElementsByClassName) {
    ...
    q = function (a, b, d) {
      for (d = d || a.offsetWidth; d < c.minSize && b && !a._lazysizesWidth; ) d = b.offsetWidth,
      b = b.parentNode;
      return d
    },
    r = function (a) {
    ...
    s = function () {
      ...
      N = function (a, b) {
        ...
        for (y -= b, B += b, z -= b, A += b; e && (d = d.offsetParent); ) e = (p(d, 'opacity') || 1) > 0,
        e && 'visible' != p(d, 'overflow') && (c = d.getBoundingClientRect(), e = A > c.left && z < c.right && B > c.top - 1 && y < c.bottom + 1);
        return e
      },
      O = function () {
        var a,
        ...
        k,
        l;
        if ((v = c.loadMode) && 8 > K && (a = i.length)) {
          for (d = Date.now(), b = L, J++, D > I && 1 > K && J > 4 && v > 2 ? (I = D, J = 0) : I = I != C && v > 1 && J > 3 ? C : H; a > b; b++, L++) if (i[b] && !i[b]._lazyRace) if (G) if ((k = i[b].getAttribute('data-expand')) && (h = 1 * k) || (h = I), l !== h && (w = innerWidth + h, x = innerHeight + h, j = - 1 * h, l = h), e = i[b].getBoundingClientRect(), (B = e.bottom) >= j && (y = e.top) <= x && (A = e.right) >= j && (z = e.left) <= w && (B || A || z || y) && (s && 3 > K && 4 > J && !k && v > 2 || N(i[b], h))) S(i[b], !1, e.width),
          L--,
          d++,
          g = !0;
           else {
            if (J && Date.now() - d > 3) return L++,
            void P();
            !g && s && !f && 3 > K && 4 > J && v > 2 && (q[0] || c.preloadAfterLoad) && (q[0] || !k && (B || A || z || y || 'auto' != i[b].getAttribute(c.sizesAttr))) && (f = q[0] || i[b])
          } else S(i[b]);
          f && !g && S(f)
        }
        L = 0
      ...
      P = r(O),
      Q = function (a) {
        k(a.target, c.loadedClass),
        l(a.target, c.loadingClass),
        m(a.target, Q)
      },
      R = function (a, b) {
        try {
      ...
      S = function (a, b, d) {
        ...
        C = E.test(a.nodeName),
        D = a.getAttribute(c.sizesAttr) || a.getAttribute('sizes'),
        G = 'auto' == D;
        (!G && s || !C || !B || a.complete || j(a, c.errorClass)) && (a._lazyRace = !0, g(function () {
          if (a._lazyRace && delete a._lazyRace, l(a, c.lazyClass), !(y = n(a, 'lazybeforeunveil', {
            force: !!b
          })).defaultPrevented) {
            if (D && (G ? (t.updateElem(a, !0, d), k(a, c.autosizesClass)) : a.setAttribute('sizes', D)), v = a.getAttribute(c.srcsetAttr), r = a.getAttribute(c.srcAttr), C && (w = a.parentNode, x = h.test(w.nodeName || '')), z = y.detail.firesLoad || 'src' in a && (v || r || x), z && (K++, m(a, M, !0), clearTimeout(u), u = f(M, 2500), k(a, c.loadingClass), m(a, Q, !0)), x) for (e = w.getElementsByTagName('source'), i = 0, p = e.length; p > i; i++) (A = c.customMedia[e[i].getAttribute('data-media') || e[i].getAttribute('media')]) && e[i].setAttribute('media', A),
            q = e[i].getAttribute(c.srcsetAttr),
            q && e[i].setAttribute('srcset', q);
            v ? a.setAttribute('srcset', v) : r && (F.test(a.nodeName) ? R(a, r) : a.setAttribute('src', r)),
            (v || x) && o(a, {
              src: r
            })
          }(!z || a.complete && B == (a.currentSrc || a.src)) && (z && M(y), Q(y)),
          a = null
        }))
      },
      T = function () {
      ...
      return {
        _: function () {
          i = b.getElementsByClassName(c.lazyClass),
          q = b.getElementsByClassName(c.lazyClass + ' ' + c.preloadClass),
          C = c.expand,
          D = Math.round(C * c.expFactor),
          e('scroll', P, !0),
          e('resize', P, !0),
          a.MutationObserver ? new MutationObserver(P).observe(d, {
            childList: !0,
            subtree: !0,
            attributes: !0
          }) : (d.addEventListener('DOMNodeInserted', P, !0), d.addEventListener('DOMAttrModified', P, !0), setInterval(P, 999)),
          e('hashchange', P, !0),
          [
            'focus',
            'mouseover',
          ...
          (s = /d$|^c/.test(b.readyState)) ? T() : (e('load', T), b.addEventListener('DOMContentLoaded', P)),
          P()
        },
        checkElems: P,
        unveil: S
...
/* responsive-nav - v1.0.39 - Licensed MIT */
!function (a, b, c) {
  'use strict';
  var d = function (d, e) {
    ...
    o = function (a) {
      ...
      for (var b = [
      ], c = 0; c < a.children.length; c++) 1 === a.children[c].nodeType && b.push(a.children[c]);
      return b
    },
    p = function (a, b) {
    ...
    v = function (b, c) {
      ...
      this.wrapper.inner = o(this.wrapper),
      h = this.options,
      g = this.wrapper,
      this._init(this)
    };
    return v.prototype = {
      destroy: function () {
        ...
        r(g, 'opened'),
        r(g, h.navClass),
        r(g, h.navClass + '-' + this.index),
        r(u, h.navActiveClass),
        g.removeAttribute('style'),
        g.removeAttribute('aria-hidden'),
        n(b, 'resize', this, !1),
        n(b, 'focus', this, !1),
        n(a.body, 'touchmove', this, !1),
        n(i, 'touchstart', this, !1),
        n(i, 'touchend', this, !1),
        n(i, 'mouseup', this, !1),
        n(i, 'keyup', this, !1),
        n(i, 'click', this, !1),
        h.customToggle ? i.removeAttribute('aria-hidden') : i.parentNode.removeChild(i)
      },
      toggle: function () {
      ...
      _onTouchStart: function (a) {
        Event.prototype.stopImmediatePropagation || this._preventDefault(a),
